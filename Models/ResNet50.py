"""
Created on Fri Feb 21 2025 2025
...
save_path="C:\\Users\\jcac\\OneDrive - KTH\\Python\\CNN\\Journal-2\\Saved_models\\best_ResNet50v02.pth"
save_probs_path="C:\\Users\\jcac\\OneDrive - KTH\\Python\\CNN\\Journal-2\\Results\\00_Probabilities\\ResNet50\\"
...
def load_ResNet50(num_classes, device):
...
def save_validation_csv(save_path, epoch, filenames_list, val_labels_list, predictions, all_probs):
    ...
    csv_file_path = os.path.join(save_path, f"ResNet_best_val_results.csv")
...
def evaluate_final_model(model, test_loader, criterion, device):
    ...
    csv_file_path = os.path.join(save_probs_path, "ResNet_test_probs.csv")
    df_probs.to_csv(csv_file_path, index=False)
...
if __name__ == "__main__":
    ...
    model = load_ResNet50(num_classes, device)
